...
def program_to_string(program: bytes) -> str: ...


def deserialize_ops(variant: int, input: bytes, destination_type: bytes, program: bytes, imported_programs: list[bytes]) -> bytes: ...


def serialize_ops(variant: int, input: bytes, destination_type: bytes) -> bytes: ...


def ecdsa_verify_ops(variant: int, signature: bytes, public_key: bytes, message: bytes) -> bool: ...


def snark_verify_ops(variant: int, verifying_key: bytes, varuna_version: bytes, inputs: bytes, proof: bytes) -> bool: ...
